  ...
  return (
    <main className="min-h-screen bg-main-50 text-main-900">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 py-6 md:px-8">
        <header className="flex items-center justify-between border-b border-main-200 pb-5">
          ...
          <nav className="flex items-center gap-2 text-sm">
            <Link
              className="rounded-md px-3 py-2 font-medium text-main-700 hover:bg-main-100"
              href="/auth/login"
            >
              Login
            </Link>
            <Link
              className="rounded-md bg-primary-700 px-3 py-2 font-semibold text-white hover:bg-primary-800"
              href="/dashboard"
            >
              Open Dashboard
            </Link>
        ...
        <div className="grid flex-1 items-center gap-8 py-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <h1 className="mt-3 max-w-3xl text-4xl font-semibold leading-tight text-main-950 md:text-6xl">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link
                className="rounded-md bg-primary-700 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-primary-800"
                href="/auth/register"
              >
                Create Account
              </Link>
              <Link
                className="rounded-md border border-main-300 px-5 py-3 text-center text-sm font-semibold text-main-800 hover:bg-main-100"
                href="/admin"
              >
                Admin Workspace
              </Link>
          ...
          <div className="rounded-md border border-main-200 bg-main-0 p-5 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded bg-success-100 px-2 py-1 text-xs font-semibold text-success-800">
                Strong
              </span>
            </div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {features.map((feature) => (
                <div className="rounded-md bg-main-50 p-4 text-sm font-medium text-main-700" key={feature}>
                  {feature}
                </div>
              ))}
            </div>
